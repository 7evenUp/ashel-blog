...
export default function AboutItem({heading, body, link}: AboutItemType) {
  return (
    <a href={link} target="_blank" className="group flex justify-between gap-6 md:gap-10 flex-col md:flex-row">
      <div className="md:border-b">
        <h2 className={`font-serif text-4xl sm:text-5xl text-white drop-shadow-[0_0_1px_rgb(0,0,0)] md:w-[348px] tracking-wider
