      ...
      {post !== undefined && 
        <>
          <div className="flex items-baseline gap-4 mb-4 mt-6">
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl">{post.title}</h1>
            <div className="flex items-center gap-1">
              <svg className="w-[14px] h-[14px] mt-[1px]" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
